	...
	<table class="wpos-plugin-pricing-table">
		...
		<colgroup></colgroup>	
	    	...
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>WP Featured Post</strong> and <strong>all other products</strong> with a single purchase.</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>WP Featured Post</strong> and <strong>all other products</strong> with a single purchase.</p>
