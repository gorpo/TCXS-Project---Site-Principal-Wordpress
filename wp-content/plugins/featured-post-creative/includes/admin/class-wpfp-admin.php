...
class Wpfp_Admin {
	...
	function wpfp_register_menu() {
		...
		add_menu_page( __('Fetured Post Settings', 'featured-post'), __('Fetured Post Settings', 'featured-post'), 'manage_options', 'wpfp-about',  array($this, 'wpfp_settings_page'), 'dashicons-sticky', 6 );
