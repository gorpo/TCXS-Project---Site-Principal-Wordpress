        ...
        <div class="swiper-wrapper">
			...
			<?php endif; ?>
						...
						<div class="slide-wrapper">
							...
							<?php if( ($slider->get('small-text') != '') || ( $slider->get('big-text') != '' ) ):?>

							<div class="slide-text<?php echo 'yes' == $slider->get('border-text') ? ' border' : ''; ?> <?php $slider->the('position-text'); ?>">

								<?php
									if( $slider->get('big-text') != '' ){
										echo '<h3>'. yit_decode_title( $slider->get('big-text') ) .'</h3>';
									}
									if( $slider->get('small-text') != '' ){
										echo '<h4>'. yit_decode_title( $slider->get('small-text') ) .'</h4>';
									}
								?>
							</div>
