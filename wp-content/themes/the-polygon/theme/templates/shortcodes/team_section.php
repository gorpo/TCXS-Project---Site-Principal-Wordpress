	...
	if ( ! empty( $team_members ) ):
		...
		<div class="col-md-<?php echo $item_span; ?> team-author-box">
			<div class="team-author-innerbox team-clearfix">
				<div class="team-member-identity col-sm-6 col-xs-6">
				...
				<div class="team-member-info col-sm-6 col-xs-6">
					<div class="team-member-description">
                       <?php
                            if( $show_role ){
                                $role = get_post_meta( $member->ID, '_member_role', true );
                                if( ! empty( $role ) ){
                                    echo ' <h5 class="team-member-role">'.esc_attr( $role ).'</h5>';
                                }
                            }
                            ?>
						...
						<div class="team-member-social">
							<?php foreach ( $socials as $social ) {
								...
								if ( $curr_social != '' ) {
									...
									echo do_shortcode( '[social icon_size="14"  square_size="25" circle_border_size="1" href="' . $curr_social . '" title="' . $socials_title . $social_name . '" icon_type="icon" icon_social="' . $social . '" circle="no" target="" ]' );
								}
							}
							?>
						</div>
