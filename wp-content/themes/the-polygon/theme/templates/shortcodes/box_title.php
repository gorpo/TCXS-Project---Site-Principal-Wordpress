...
$font_color = ( isset( $font_color ) || $font_color != '' ) ? $font_color: '#434343';
$font_alignment = ( isset( $font_alignment ) || $font_alignment != '' ) ? $font_alignment: 'center';
$border = ( isset( $border ) || $border != '' ) ? $border : 'none';
$title = ( isset( $title ) && $title != '' ) ? $title : '';

$title_style = "font-size: ".$font_size."px; color: " .$font_color .";" ;
$subtitle_style = "font-size: ".$subtitle_font_size."px; color: " .$font_color .";" ;
...
<div class="box-title-wrapper">
    ...
    switch ( $border ):
        ...
        case 'middle':
            ?>
            <div id="<?php echo $id ?>" class="box-title box-title-text-<?php echo esc_attr( $font_alignment . $animate. ' '. $border . $vc_css ) ?> box-title-line-middle wrap-title <?php echo ( isset( $class ) ) ? $class : '' ?>" <?php echo $animate_data ?>>
                <div class="title-bar">
                    <h2 style="<?php echo $title_style ?>" >
                        <?php echo yit_decode_title( $title ) ?>
                    </h2>
        ...
        default:
            ...
            <div id="<?php echo $id ?>" class="box-title box-title-text-<?php echo $font_alignment . $animate . ' ' . $border ?> box-title-line-none <?php echo ( isset( $class ) ) ? $class : '' ?>" <?php echo $animate_data ?>>
                <h2 style="<?php echo $title_style ?>">
                    <?php echo yit_decode_title( do_shortcode( $title ) ) ?>
                </h2>
                <?php if( $subtitle != '' ):?>
                    <p class="subtitle" style="<?php echo $subtitle_style ?>">
                        <?php echo $subtitle?>
