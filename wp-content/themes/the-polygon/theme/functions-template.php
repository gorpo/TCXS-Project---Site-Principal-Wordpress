...
if ( ! function_exists( 'yit_button_style' ) ) {
    ...
    function yit_button_style( $button = array() ) {
        ...
        $button['flat-green']    = __( 'Flat Green', 'yit' );
        $button['flat-black'] = __( 'Flat Black', 'yit' );
...
if ( ! function_exists( 'yit_slogan_background' ) ) {
    ...
    function yit_slogan_background() {
        ...
        if ( ! empty( $height ) ) {
            $css['#slogan'][] = 'height: ' . $height . 'px;';
            $css['#slogan .slogan-wrapper'][] = 'height: ' . $height . 'px;';
        }

        if ( ! empty( $color ) ) {
            $css['#slogan'][] = 'background-color: ' . $color . ';';
        }

        if ( ! empty( $image ) ) {

            $css['#slogan'][] = "background-image: url('$image');";

            if ( ! empty( $repeat ) ) {
                $css['#slogan'][] = "background-repeat: $repeat;";
            }

            if ( ! empty( $position ) ) {
                $css['#slogan'][] = "background-position: $position;";
            }

            if ( ! empty( $attachment ) ) {
                $css['#slogan'][] = "background-attachment: $attachment;";
            }
        }
	    ...
	    if ( ! empty( $slogan_color ) ) {
		    $css['#slogan h1, #slogan h2'][] = 'color:' . $slogan_color . ';';
	    }
        ...
        if ( isset( $value ) && $value != '' ){
            ...
            <li>
                <?php if ( $icon_type=='custom'  ) :  ?>
                    ...
                    <?php elseif ( $icon_type=='theme-icon'  ) :  ?>
...
if( ! function_exists( 'yit_contact_form_buttons_style' ) ) {
    ...
    */
    ...
    function yit_contact_form_buttons_style(){
        return array(
            'ghost'         => __( 'Ghost', 'yit' ),
            'flat-green'      => __( 'Flat Green', 'yit' ),
            'flat-black'   => __( 'Flat Black', 'yit' ),
        );
    }
}
            ...
            'attributes' => array(
                ...
                'button_class' => array(
                    ...
                    'options' => array(
                       ...
                       'btn-flat-green' => __( 'Flat Green', 'yit' ),
                       'btn-flat-black' => __( 'Flat Black', 'yit' )
                    ),
                    'std'     => 'btn-flat-black'
                )
            )
