...
return array(
    ...
    array(
        ...
        'style' => array(
            'selectors'  => '#header, #header.search-small #header-search',
        ...
        'style'      => array(
            'normal' => array(
                'selectors'  => '.header-nav ul li a,
                                 ...
                                 #header-search .shop-by-category .list-trigger .sbToggle,
                                 #header-search .shop-by-category .list-trigger:hover.sbToggle',
                'properties' => 'color'
            ),
            'hover'  => array(
    ...
    array(
        ...
        'style'           => array(
            'selectors'  => '.nav div.submenu ul li a, #header .sbHolder .sbOptions li a, #topbar .nav > ul > li > a',
            'properties' => 'font-size,
                              font-family,
                              font-weight,
                              text-transform,
    ...
    array(
        ...
        'style'           => array(
            'selectors'  => '#header-search, .slider-container .shop-by-category > div.submenu-group > div.submenu div.submenu',
            'properties' => 'border-color'
        )
    ),
    ...
    array(
        ...
        'style'           => array(
            'selectors'  => '.slider-container .shop-by-category > div.submenu-group > div.submenu,
                            #header-search .shop-by-category > div.submenu-group > div.submenu,
                            .slider-container .shop-by-category > div.submenu-group > div.submenu div.submenu,
                            #header-search .shop-by-category > div.submenu-group > div.submenu div.submenu,
