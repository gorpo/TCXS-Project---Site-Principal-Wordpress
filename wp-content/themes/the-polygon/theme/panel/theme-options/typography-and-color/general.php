...
return array(
    ...
    array(
        ...
        'style'      => array(
            'selectors'  => 'h1, h2, h3, h4, h5, h6,
                            ...
                            div.blog_post .yit_post_date span,
                            .piechart span,
    ...
    array(
        ...
        'style'     => array(
            'selectors'  => '.highlight, .numbers-sections h4 span.title-highlight, .dropcap, span.price ins span.amount',
            'properties' => 'color'
        ),
    ...
    array(
        ...
        'style'   => array(
            'selectors'  => '.boxed-layout #wrapper, .boxed-layout .blog.single .content-style-social,
                            #product-nav > a > div, .single-product.woocommerce .woocommerce-tabs ul li.active,
                            #customer_login .wp-social-login-widget,
    ...
    array(
        ...
        'style'           => array(
            'selectors'  => '.tooltip-inner, .thumb-wrapper .added-to-cart-icon span ',
            'properties' => 'font-size,
                             font-family,
                             font-weight,
                             color,
    ...
    array(
        ...
        'style'          => array(
            'background' => array(
                'selectors'  => '.tooltip-inner, div.team-member-name span',
                'properties' => 'background-color'
            ),
            'arrow' => array(
                'selectors' => '.tooltip',
