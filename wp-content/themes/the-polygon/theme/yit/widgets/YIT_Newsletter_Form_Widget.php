...
if ( ! defined('YIT_NEWSLETTER_VERSION') ) {
  return;
}
/**
 * YIT_Newsletter_Form
 ...
 */
if( !class_exists( 'YIT_Newsletter_Form_Widget' ) ) :
    class YIT_Newsletter_Form_Widget extends WP_Widget {
        ...
        public function form( $instance ) {
            $defaults = array(
                ...
                'text'        => '',
                'with_border' => 'no',
                'button_class' => 'btn btn-flat-green'
            );
        ...
        public function widget( $args, $instance ) {
            ...
            yit_plugin_get_template( untrailingslashit( YIT_Newsletter()->plugin_path ), 'shortcodes/newsletter_form.php', $args );
