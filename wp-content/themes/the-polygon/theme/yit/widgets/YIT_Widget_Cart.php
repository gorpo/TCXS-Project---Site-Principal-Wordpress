...
class YIT_Widget_Cart extends WP_Widget {
	...
	function widget( $args, $instance ) {
        ...
        if( ! is_shop_installed() || ! function_exists('yit_get_current_cart_info') ) return;
        ...
        <div class="yit_cart_widget widget_shopping_cart">
            ...
            <a class="cart_label cart-items" href="<?php echo wc_get_cart_url(); ?>">
	            <span class="yit-mini-cart-image"><?php echo $icon_cart ?></span>
