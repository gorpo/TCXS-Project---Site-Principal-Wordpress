           ...
           // var_dump($instance);
        	                                    ...
        	                                    <div class="customer-login-box customer-login-box1">
                                                    ...
                                                    <form method="post" class="login">
                                                        ...
                                                        <div class="form-group login-submit">
                                                            ...
                                                            <input type="submit" class="button btn btn-flat-green button-login" name="login" value="<?php _e( 'Login', 'yit' ); ?>" />
            ...
            if( $nav_show_wishlist ): ?>
                <div class="nav whislist_nav">
                    <ul>
                        <li>
                            <a href="<?php echo wc_get_endpoint_url( ( is_user_logged_in() ? 'myaccount-' : '' ) . 'wishlist', '',  get_permalink( wc_get_page_id( 'myaccount' ) ) ) ?>"><?php  _e('My Wishlist', 'yit') ?></a>
                        </li>
                    </ul>
                </div>
            <?php endif;
