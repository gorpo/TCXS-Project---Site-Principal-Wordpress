...
if ( ! class_exists( 'YIT_Widget_Contact_Info' ) ) :
    ...
    class YIT_Widget_Contact_Info extends WP_Widget {
        ...
        function widget( $args, $instance ) {
            ...
            $text .= ( ! empty( $instance['email'] ) && !empty( $instance['email_text'] ) ) ? '<li>' . $email_image . '<div class="info-container"><a href="mailto:' . $instance['email'] . '" class="contact_info_email">' . do_shortcode( $instance['email_text'] ) . '</a></div></li>' : '';
