...
$theme_shortcodes = array(
    ...
    'box_section' => array(
        ...
        'attributes' => array(
            ...
            'border_size'     => array(
                'title' => __( 'Border Square Width ("0" for no border)', 'yit' ),
                'type'  => 'number',
                'std'   => '3',
                'deps'  => array(
                    'ids'    => 'icon_type',
    ...
    'social' => array(
        ...
        'attributes' => array(
            ...
            'square_background_color' => array(
                'title' => __('Square Background Color', 'yit'),
                'type'  => 'colorpicker',
                'std' => '#ffffff',
                'deps' => array(
                    'ids' => 'square',
            ...
            'square_border_color' => array(
                'title' => __('Square Border Color', 'yit'),
                'type'  => 'colorpicker',
                'std' => '#ffffff',
                'deps' => array(
                    'ids' => 'square',
        ...
        'single_product_two' => array(
            ...
            'attributes' => array(
                ...
                'variation_title' => array(
                    'title' => __( 'Variations title (if any)', 'yit' ),
                    'type'  => 'text',
                    'desc'  => __( 'Show a title before the product variations (if any)', 'yit' ),
                    'std'   => 'Available for:'
                ),
                'animate'         => array(
                    'title'   => __( 'Animation', 'yit' ),
