...
<form action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post" class="clearfix cart-page woocommerce-cart-form">
                                ...
                                <td class="product-remove">
                                    <?php
                                        echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
                                            '<a href="%s" title="%s" class="remove a-style-2">X</a>',
                                ...
                                <table class="shop_table coupon" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <input type="submit" class="btn btn-flat-green" name="apply_coupon" value="<?php _e( 'Apply', 'yit' ); ?>" />
