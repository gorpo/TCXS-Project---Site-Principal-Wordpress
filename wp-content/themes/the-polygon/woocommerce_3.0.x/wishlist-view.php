        ...
        <tr>
	        <td colspan="<?php echo esc_attr( $column_count ) ?>">
		        <div class="custom-add-to-cart-button-container">
		            ...
		            <?php if( $show_cb ) : ?>
		                <a href="<?php echo esc_url( add_query_arg( array( 'wishlist_products_to_add_to_cart' => '', 'wishlist_token' => $wishlist_meta['wishlist_token'] ) ) ) ?>" class="btn btn-flat-green button alt" id="custom_add_to_cart"><?php _e( 'Add the selected products to the cart', 'yit' ) ?></a>
		            <?php endif; ?>
		        </div>
...
<?php if( $additional_info ): ?>
	<div id="ask_an_estimate_popup">
		<form action="<?php echo $ask_estimate_url ?>" method="post" class="wishlist-ask-an-estimate-popup">
			...
			<button class="btn btn-flat-green button ask-an-estimate-button ask-an-estimate-button-popup" ><?php _e( 'Ask for an estimate', 'yit' ) ?></button>
		</form>
	</div>
<?php endif; ?>